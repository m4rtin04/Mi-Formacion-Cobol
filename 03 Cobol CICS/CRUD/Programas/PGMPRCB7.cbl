 ...
 *   03 WS-MAPSET-00         PIC X(07)       VALUE 'MAP0099'.  
     03 WS-MAP-01            PIC X(07)       VALUE 'MAP1CB7'.  
     03 WS-MAPSET-01         PIC X(07)       VALUE 'MAP1CB7'.  
  ...
  MAIN-PROGRAM.                                                 
      ...
      EVALUATE WS-RESP                                      
       WHEN DFHRESP(NORMAL)                                 
            ...
            MOVE LENGTH OF MAP1CB7O TO WS-LONG              
